...
class Deep_Autoencoder(object):
    def __init__(self, sess, input_dim_list, is_tuning):
        ...
        self.S = tf.compat.v1.placeholder(tf.float32,[None,self.dim_list[0]])
    ...
    def fit(self, X, Y, h, S, sess, learning_rate=0.15,
            iteration=200, batch_size=50, init=False,verbose=False, is_tuning=0):
